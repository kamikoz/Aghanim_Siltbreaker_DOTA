...
--spells with MIN/MAX VALUE that after reaching the limit will not have added talents (AbilityValues KV)
...
_G.ABILITY_UPGRADES_VALUE_MULTIPLIER = {
	axe_battle_hunger = 
	{
		armor_multiplier = 2
	},
